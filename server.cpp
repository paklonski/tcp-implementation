/*
	Computer Networks Course - The Semester Project
	Client: Pavel Paklonski
	Server: Sofia Shchepetova
        ...
        if (recvfrom(socketS, buffer_rx, sizeof(buffer_rx), 0, (sockaddr * ) & from, &fromlen) == SOCKET_ERROR) {
            ...
            if (strstr(buffer_rx, "DATA")) {
                ...
                if (crc != senderCRClong) {
                    ...
                    sendto(socketS, acknowledgement, strlen(acknowledgement) + 1, 0, (sockaddr * ) & addrDest,
                           sizeof(addrDest));
                ...
                if (startOK) {
                    sendto(socketS, "TRUETRUETRUETRUETRUETRUETRUETRUETRUETRUE", 41, 0, (sockaddr * ) & addrDest,
                           sizeof(addrDest));
                ...
                if (crc != senderCRClong) {
                    printf("WRONG CRC\n\n");
                    sendto(socketS, "FALSEFALSEFALSEFALSEFALSEFALSEFALSEFALSE", 41, 0, (sockaddr * ) & addrDest,
                           sizeof(addrDest));
                } else {
                    SHA1_Init(&ctx);
                    printf("shaInit: ");
                ...
                if (recievedSuccess) {
                    ...
                    sendto(socketS, "SUCCESSSUCCESSSUCCESSSUCCESSSUCCESSSUCC", 41, 0, (sockaddr * ) & addrDest,
                           sizeof(addrDest));
                    continue;
                }
                hashEnter++;
                ...
                if (shaTrue == SHA_DIGEST_LENGTH) {
                    ...
                    sendto(socketS, "ERRORERRORERRORERRORERRORERRORERRORERROR", 41, 0, (sockaddr * ) & addrDest,
                           sizeof(addrDest));
                    fclose(f);
                    remove(path);
