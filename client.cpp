...
int main() {
    ...
    do {
        ...
        // CREATING THE SOCKET WITH A FILENAME
        ...
        // CREATING THE SOCKET WITH A SIZE
        ...
        // CREATING THE SOCKET WITH "START"
        ...
        while (!speed_is_got) {
            if (is_receive_speed(buffer_speed)) {
                ...
                if (sockets_per_second == -1.0) {
                    sendto(socketS, "FALSEFALSEFALSEFALSEFALSEFALSEFALSE", 37, 0, (sockaddr * ) & addrDest,
                           sizeof(addrDest));
                } else {
        ...
        int tries = 0;
        do {
            sendto(socketS, (const char *) buffer_tx_hash, sizeof(buffer_tx_hash), 0, (sockaddr * ) & addrDest,
                   sizeof(addrDest));
            tries++;
